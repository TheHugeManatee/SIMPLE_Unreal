...
inline const simple_msgs::RotationMatrixFbs *GetSizePrefixedRotationMatrixFbs(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<simple_msgs::RotationMatrixFbs>(buf);
}
...
inline bool VerifySizePrefixedRotationMatrixFbsBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<simple_msgs::RotationMatrixFbs>(RotationMatrixFbsIdentifier());
}
...
inline void FinishSizePrefixedRotationMatrixFbsBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<simple_msgs::RotationMatrixFbs> root) {
  fbb.FinishSizePrefixed(root, RotationMatrixFbsIdentifier());
}
